...
По итогу проделанной работы был сделан проект, благодаря которому можно очищать файлы от пропусков и неинформативных данных. Также, данный проект позваляет очищать данные от выбросов.